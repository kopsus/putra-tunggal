...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn(
        "w-full caption-bottom text-sm border-2 border-primary",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-white titleContent [&:has([role=checkbox])]:pr-0 dark:text-neutral-400 bg-primary",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2 md:p-4 align-middle [&:has([role=checkbox])]:pr-0 border-2 border-primary",
      className
    )}
    {...props}
  />
